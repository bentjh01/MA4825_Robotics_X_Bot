...
def main():
    ...
    print(init_pose)
    init_joint = move_group.get_current_joint_values()
    print(init_joint)

    target_pose = Pose()
    target_pose.position.x = 0.15  # 设置 x 坐标
    target_pose.position.y = -0.15  # 设置 y 坐标
    target_pose.position.z = 0.168  # 设置 z 坐标
    ...
    print(final_pose)
    final_joint = move_group.get_current_joint_values()
    print(final_joint)

    # print(type(final_joint))
